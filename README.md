...
- [Alice Agent](https://alice-agent.stuko.dev) - Open-source local AI agent with persistent memory, 20+ messaging platforms, scheduled jobs, subagents, and a skills system. CLI, TUI, and desktop app. ([Source Code](https://github.com/Stuko0/alice-agent)) `MIT` `Python`
